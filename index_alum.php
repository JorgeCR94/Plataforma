    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          <a id="home"class="mdl-navigation__link" href="index_alumn.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">home</i>Inicio</a>
          ...
          <a class="mdl-navigation__link" href="listas_alum.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">forum</i>Listas especiales</a>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" style="position: fixed;xed; left: -1000px; height: -1000px;">
        <defs>

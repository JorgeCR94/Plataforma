            ...
            <div class="portlet light ">
                <div class="portlet-title tabbable-line">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#tab_1_3" data-toggle="tab"> Mis listas </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1_1">
                            <div class="scroller" style="height: 339px;" data-always-visible="1" data-rail-visible="0">
                                <ul class="feeds" id="feeed2">
                                </ul>
                            </div>
                        </div>
                        <div class="tab-pane active" id="tab_1_2">
                            <div class="scroller" style="height: 339px;" data-always-visible="1" data-rail-visible="0">
                                <ul class="feeds" id="feeed3">
                                </ul>
                            </div>
                        </div>
                    ...
                    <form role="form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="id_lista" placeholder="Nombre">
                                <label>Número de cuenta</label>
                                <input type="text" class="form-control" id="no_cuenta" placeholder="Nombre">
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    ...
    $('#add_list').click(function () {
        ...
        var cuenta = $('#no_cuenta').val();  
        $.ajax({
            url: 'addlist_alum.php',
            data: {id: 0, id_lista_especial:id_lista, alumno_id: cuenta},
            type: 'POST',
            dataType: 'json',
    ...
    $( document ).ready(function() {
        var cuenta = '<?php echo $_SESSION["Cuenta"]; ?>'; 
        $.ajax({
            url: 'addlist_alum.php',
            data: {id:2,cuenta:cuenta},
            type: 'POST',
            dataType: 'json',
            success: function (data) {
            ...
            success: function (data) {
                for (var i = 0; i<data.length; i++){
                    ...
                    $('#feeed2').append('<li>\n' +
                        ...
                        '                                                        </div>' +
                        '                                                    </div>' +
                        '                                                    <div class="cont-col2">' + '<div class="desc">'+ data[i]["id"]+'</div>' +
                        '                                                        <div class="desc"> '+data[i]["nombre"]+' <span class="label label-sm label-info">'+data[i]["descripcion"]+
                        '                                                                            </span></div>' +
                        '                                                    </div>' +
                        '                                                </div>' +
